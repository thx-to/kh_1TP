package TEST_241028_TERMINAL_COMPLETE;

import TEST_241028_TERMINAL_COMPLETE.Common.Session;
import TEST_241028_TERMINAL_COMPLETE.DAO.*;
import TEST_241028_TERMINAL_COMPLETE.VO.Acc_InfoVO;
import TEST_241028_TERMINAL_COMPLETE.VO.Inv_OrderVO;
        ...
        while (isCustomerLoggedIn) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    Order_RecordDAO.userOrderList(userId);
                    break;
                case 3:
